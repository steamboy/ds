<?php
include('../../../../includes/config.php'); //Include config.inc (main config)
...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//define('CONFIG_SYS_DEFAULT_PATH', '../../../../'.$theme_location.'images/'); //accept relative path only
	//define('CONFIG_SYS_ROOT_PATH', '../../../../'.$theme_location.'images/');	//accept relative path only
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../resources/'); //accept relative path only
    define('CONFIG_SYS_ROOT_PATH', '../../../../resources/');    //accept relative path only
