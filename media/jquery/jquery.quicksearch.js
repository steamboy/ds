jQuery(function ($) {
	$.fn.quicksearch = function (opt) {
		...
		function make_form_input()
		{
			...
			return '<input class="not_quick_search" type="text" value="' + val + '" rel="' + options.randomElement  + '" class="' + options.inputClass + '" id="' + options.randomElement + '" /><div style="height:4px;">&nbsp;</div><input type="button" value="Search" id="button_search" style="width:100px;">';
		}
